...
const useStyles = makeStyles(({ breakpoints, spacing }) => ({
  ...
  media: {
    ...
    '&:after': {
      ...
      height: '100%',
      backgroundImage:
        'linear-gradient(90deg, rgba(240,123,63,1) 41%, rgba(255,212,96,1) 79%)',
          ...
          <Card className={cx(styles.root, shadowStyles.root)}>
            ...
            <CardContent>
              ...
              <Button
                ...
                href="https://github.com/Zeeshan-2k1/Auth-Project"
              >
                View
              </Button>
            </CardContent>
        ...
        <Grid item xs={12} sm={8} md={6} className={styles.myStyle}>
          <Card className={cx(styles.root, shadowStyles.root)}>
            ...
            <CardContent>
              ...
              <Button
                className={buttonStyles}
                href="https://github.com/Zeeshan-2k1/Keeper_App"
              >
                View
              </Button>
            </CardContent>
        ...
        <Grid item xs={12} md={6} sm={8} className={styles.myStyle}>
          <Card className={cx(styles.root, shadowStyles.root)}>
            ...
            <CardContent>
              ...
              <Button
                className={buttonStyles}
                href="https://github.com/Zeeshan-2k1/Weather"
              >
                View
              </Button>
            </CardContent>
